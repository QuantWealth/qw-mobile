...
import 'ui/auth/cubit/auth_cubit.dart' as _i14;
...
import 'ui/auth/infrastructure/repository/auth_repository.dart' as _i12;
import 'ui/balance/cubit/balance_cubit.dart' as _i13;
import 'ui/balance/infrastructure/repository/balance_repository.dart' as _i9;
import 'ui/savings/cubit/savings_cubit.dart' as _i11;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i11.SavingsCubit>(() =>
        _i11.SavingsCubit(savingsRepository: gh<_i10.SavingsRepository>()));
    gh.lazySingleton<_i12.AuthRepository>(() => _i12.AuthRepository(
        authLocalDatasource: gh<_i7.AuthLocalDatasource>()));
    gh.lazySingleton<_i13.BalanceCubit>(() =>
        _i13.BalanceCubit(balanceRepository: gh<_i9.BalanceRepository>()));
    gh.lazySingleton<_i14.AuthCubit>(
        () => _i14.AuthCubit(authRepository: gh<_i12.AuthRepository>()));
    return this;
  }
}
